...
## 摘要
本文以已筛定的109本高质量期刊石油领域文献数据为基础数据源，整合CNKI、WOS与CSCD三库2011-2025年记录，构建覆盖311321篇文献的双主键去重正式语料。研究首先按照“标准DOI键优先、元数据回退键补充”的规则完成跨库去重，并通过机构译名清洗、标准化归并与子单元过滤构建机构分析底表；随后从科研产出、学术影响、合作与国际化三个维度提取7项指标，采用先验权重、熵权法与CRITIC法的组合赋权方案，通过TOPSIS对全球石油领域核心研究机构开展综合评价；最后基于103768篇建模文献，按2011-2015、2016-2020、2021-2025三个阶段构建LDA主题模型，分析研究热点演化路径以及不同机构类型、机构层级的主题偏好差异。结果表明：TOPSIS综合排名前两位分别为中国科学院和中国石油大学（北京），其中中国科学院综合得分为0.793235；机构画像环节共识别7887个有效标准化机构，其中企业研发中心5314家、高校/科研院所2433家、政府机构19家；三阶段模型最优主题数分别为12、10和11，共识别14条主题演化路径，研究热点总体呈现出由盆地构造、油田开发与传统催化转化，逐步转向储层预测、二氧化碳利用与储存、催化活性和材料稳定性等方向的趋势。高校/科研院所在知识探索型主题上更具优势，企业研发中心则更集中于工程开发与应用导向主题。研究为石油领域科研机构竞争力诊断、主题布局优化和资源配置决策提供了可复现的数据分析路径。
...
### 2.3 机构标准化与研究样本构建
机构标准化遵循“译名可读、标准名统一、颗粒度一致”的原则。对实验室、学院、研究中心、分院等子单元，若能够稳定回溯到母机构，则统一归并到母机构层级；对具有独立学术身份且无法合理归并的机构，则保留独立标准名。经清洗后，机构画像表共保留7887个有效标准化机构，其中企业研发中心5314个，高校/科研院所2433个，政府机构19个，另有121个机构暂列“其他”，不纳入正式类型比较。
在核心评价样本方面，本文依据TOPSIS综合得分构建前100机构集合。考虑到机构画像链条实际成功联接98家核心机构，后续类型和层级比较均以这98家为准：其中高校/科研院所93家、企业研发中心5家；按层级划分则包括头部引领型20家、中坚创新型30家和特色细分型48家。

表2-1 机构类型分布情况

| 机构类型 | 机构数量 | 说明 |
| --- | --- | --- |
| 企业研发中心 | 5314 | 标准化后数量最多，反映产业主体广泛参与 |
| 高校/科研院所 | 2433 | 在高影响与头部排名中占据主导 |
| 政府机构 | 19 | 主要包括部委、调查机构与国家技术机构 |
| 其他 | 121 | 未纳入正式类型比较 |
...
由此可见，高校/科研院所更偏向知识探索和机理阐释主题，而企业研发中心则持续围绕储层评价、盆地构造和工程开发等应用导向议题展开布局。政府机构样本虽已由原先的极少数识别结果修正为19家，但总体规模仍然偏小，且部分记录仍以调查中心、研究所等下属单元形态出现，因此其主题分布可作补充观察，但不宜与高校/科研院所、企业研发中心进行强度相当的正式比较。
...
### 5.5 研究局限
本文仍存在三点局限。第一，机构类型识别虽已显著改善，但仍有121个机构暂列“其他”，说明少量跨国联盟、中心类组织及边界模糊机构的属性辨识仍需进一步细化。第二，由于缺乏可追溯的专家评分数据，本文未将德尔菲法纳入实际赋权流程，而是采用完全可复现的组合客观赋权方案。第三，政府机构识别虽已补入部委、调查机构和国家技术机构，但部分记录仍停留在下属调查中心或研究所层级，后续仍需继续向母机构归并，以进一步提升机构类型比较的一致性与颗粒度稳定性。

## 6 结论

本文基于109本高质量期刊石油领域文献数据，构建了覆盖2011-2025年的311321篇双主键正式语料，并在7887个有效标准化机构基础上完成了从机构标准化、TOPSIS综合评价到主题演化比较的一体化分析。研究表明，中国科学院、中国石油大学（北京）等机构在综合评价中位居前列，头部格局体现出大型科研院所、行业特色高校与石油企业主体并存的结构特征。
